...
console.log(account1.toString());
const webUser2 = new WebUser_1.WebUser("Noey", "Nubnoey1234", UserState_1.UserState.NEW);
const customer2 = new Customer_1.Customer("02", webUser2, "Nakhon Pathom", 123456789, "test2@gmail.com");
const payment2 = new Payment_1.Payment("PY2", "250", 5000, "credit");
const account2 = new Account_1.Account("07", customer2, "Nakhon Pathom", true, "8:00", "18:00", payment2);
